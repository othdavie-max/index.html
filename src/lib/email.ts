...
export function wrapEmail(title: string, bodyHtml: string) {
  ...
  <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; color: #0B1220;">
    <div style="background:#0A1F44; padding: 24px; border-radius: 12px 12px 0 0;">
      <span style="color:#fff; font-size:20px; font-weight:700;">Baseline<span style="color:#E03A3E;">.</span></span>
    </div>
    <div style="border: 1px solid #E6ECF6; border-top: none; padding: 24px; border-radius: 0 0 12px 12px;">
      <h2 style="color:#0A1F44; margin-top:0;">${title}</h2>
      ${bodyHtml}
    </div>
    <p style="color:#5B6577; font-size:12px; margin-top: 16px; text-align:center;">
