  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex border-t border-navy-900/10 bg-white/95 backdrop-blur-lg sm:hidden">
      <button
        ...
        className="flex flex-1 items-center justify-center gap-2 border-r border-navy-900/10 py-3.5 text-sm font-semibold text-[#128C4A]"
      >
      ...
      <Link href="/book" className="flex flex-1 items-center justify-center gap-2 bg-red-500 py-3.5 text-sm font-semibold text-white">
