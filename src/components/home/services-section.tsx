            ...
            return (
              <RevealItem key={service.slug} className="w-[280px] shrink-0 snap-start lg:w-auto">
                <Link
                  ...
                  className="group flex h-full flex-col rounded-2xl border border-navy-900/8 bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(10,31,68,0.2)]"
                >
                  ...
                  <span className="mt-4 flex items-center gap-1 text-sm font-medium text-red-500 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
