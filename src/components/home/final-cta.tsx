...
export function FinalCta() {
  return (
    <section className="relative overflow-hidden bg-navy-900 py-20 sm:py-28">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(224,58,62,0.25),transparent_55%)]" />
      <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <Reveal>
          <h2 className="font-display text-balance text-[clamp(1.75rem,4.5vw,3rem)] font-bold leading-tight text-white">
            Ready to start your <span className="font-serif-em font-normal text-red-400">study abroad</span> journey?
          </h2>
