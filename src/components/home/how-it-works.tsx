        ...
        <div className="mt-14 grid grid-cols-1 gap-10 lg:grid-cols-2">
                ...
                >
                  <span
                    className={cn(
                      ...
                      active === i ? "border-red-500 bg-red-500 text-white" : "border-white/20 text-white/60",
                    )}
                  >
                    {i + 1}
                  </span>
          ...
          <div className="relative hidden lg:block">
            <div className="sticky top-28 flex aspect-square items-center justify-center rounded-3xl border border-white/10 bg-white/[0.03]">
              <span className="font-display text-[10rem] font-bold leading-none text-white/10">{active + 1}</span>
              <div className="absolute bottom-10 left-10 right-10">
                <p className="font-display text-2xl font-bold text-white">{howItWorksSteps[active].title}</p>
