    ...
    <>
      ...
      <section className="bg-white py-16 sm:py-24">
        <div className="legal-content mx-auto max-w-3xl px-4 text-sm leading-relaxed text-navy-900 sm:px-6 sm:text-base lg:px-8">
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">1. Acceptance of terms</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">2. Our services</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">3. No guaranteed outcomes</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">4. Fees</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">5. Your responsibilities</h2>
          <ul>
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">6. Intellectual property</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">7. Limitation of liability</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">8. Changes to these terms</h2>
          ...
          <h2 className="mt-8 font-display text-xl font-bold text-navy-900">9. Contact</h2>
