    ...
    <>
      ...
      <section className="bg-white py-16 sm:py-24">
        <div className="legal-content mx-auto max-w-3xl px-4 text-sm leading-relaxed text-ink-900 sm:px-6 sm:text-base lg:px-8">
          ...
          <h2 className="mt-8 font-display text-xl text-ink-900">Types of cookies we use</h2>
          <div className="mt-4 overflow-hidden rounded-xl border border-ink-900/10">
            <table className="w-full border-collapse text-left text-sm">
              <thead className="bg-offwhite">
                <tr>
                  <th className="p-3 font-semibold text-ink-900">Type</th>
                  <th className="p-3 font-semibold text-ink-900">Purpose</th>
                  <th className="p-3 font-semibold text-ink-900">Can be disabled?</th>
                </tr>
              </thead>
              <tbody>
                {cookieTypes.map((c) => (
                  <tr key={c.name} className="border-t border-ink-900/10">
          ...
          <h2 className="mt-8 font-display text-xl text-ink-900">Managing cookies</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl text-ink-900">Contact</h2>
