...
export default function SuccessStoriesPage() {
  const approved = realTestimonials.filter((t) => t.visaApproved);
      ...
      {approved.length > 0 && (
        <section className="bg-offwhite py-16 sm:py-24">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mt-4 max-w-xl text-center text-xs text-muted">Shared only with each student&apos;s consent.</p>
