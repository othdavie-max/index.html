  ...
  if (!configured) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-offwhite px-4">
        <div className="max-w-md rounded-2xl border border-gold-500/20 bg-white p-8 text-center">
          <AlertTriangle className="mx-auto text-gold-500" size={28} />
          <h1 className="mt-4 font-display text-lg text-ink-900">Supabase isn&apos;t configured</h1>
